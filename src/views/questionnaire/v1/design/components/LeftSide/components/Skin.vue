...
const skinList = [
  {
    ...
    data: {
      showLogo: false,
      logo: 'https://s21.ax1x.com/2024/10/16/pANZu8O.png',
      logoPosition: 'center',
  ...
  },
  {
    ...
    data: {
      ...
      logo: 'https://s21.ax1x.com/2024/10/16/pANZu8O.png',
      logoPosition: 'center',
      bgImage: 'https://s21.ax1x.com/2024/10/16/pANZ1rd.png',
      bgColor: '#f7f3ec',
  ...
  },
  {
    ...
    data: {
      ...
      logo: 'https://s21.ax1x.com/2024/10/16/pANZu8O.png',
      logoPosition: 'center',
      bgImage: 'https://s21.ax1x.com/2024/10/16/pANZ3qA.png',
      bgColor: '#7f1517',
  ...
  },
  {
    ...
    data: {
      ...
      logo: 'https://s21.ax1x.com/2024/10/16/pANZu8O.png',
      logoPosition: 'center',
      bgImage: 'https://s21.ax1x.com/2024/10/16/pANZJat.png',
      bgColor: '#f0f0f0',
  ...
  },
  {
    ...
    data: {
      ...
      logo: 'https://s21.ax1x.com/2024/10/16/pANZu8O.png',
      logoPosition: 'center',
      bgImage: 'https://s21.ax1x.com/2024/10/16/pANZYIP.png',
      bgColor: '#f0f0f0',
  ...
  },
  {
    ...
    data: {
      ...
      logo: 'https://s21.ax1x.com/2024/10/16/pANZu8O.png',
      logoPosition: 'center',
      bgImage: 'https://s21.ax1x.com/2024/10/16/pANZUG8.png',
      bgColor: '#f0f0f0',
      contentBgColor: '#fefdfc',
      textColor: '#333333',
      btnText: '提交',
